...
def post(id):
    ...
    if form.validate_on_submit():
        ...
        app.logger.info(f"Post updated by user {current_user.username}")
...
def authorized():
    ...
    if "error" in request.args:
        app.logger.error("Microsoft authentication error")
    ...
    if request.args.get('code'):
        ...
        if "error" in result:
            ...
            app.logger.error("Microsoft login failed")
        ...
        if user:
            ...
            app.logger.info("Microsoft login successful for admin")

        else:
            app.logger.warning("Microsoft login attempted but admin user not found")
